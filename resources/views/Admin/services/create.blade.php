...
@section('content')
<form method="POST" action="{{ route('admin.services.store') }}" enctype="multipart/form-data" data-parsley-validate>
    @csrf
    <div class="row">
        ...
        <div class="form-group my-1 col-md-6 col-sm-12">
            ...
            <textarea name="desc_home_ar" placeholder="@lang('trans.desc_home_ar')" class="mceNoEditor form-control">{{ old('desc_home_ar') }}</textarea>
        </div>
        <div class="form-group my-1 col-md-6 col-sm-12">
