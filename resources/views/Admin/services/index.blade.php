...
<div class="row">
    ...
    <div class="my-2 col-6 col-md-3 text-center">
        <a href="{{ route('admin.services.create') }}" class="main-btn" disabled>@lang('trans.add_new')</a>
    </div>
    <div class="my-2 col-6 col-md-3 text-center">
        <button type="button" id="DeleteSelected" onclick="DeleteSelected('services')" class="btn btn-dark" disabled>@lang('trans.Delete_Selected')</button>
    </div>
</div>
