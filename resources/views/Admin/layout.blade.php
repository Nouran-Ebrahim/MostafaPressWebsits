...
<head>
    ...
    <link rel="icon" href="{{ asset(setting('logo_dark')) }}" type="image/x-icon">
    ...
    <aside class="sidebar-nav-wrapper active">
        ...
        <nav class="sidebar-nav">
            <ul>
                ...
                @include('Admin.Sidebars.banners')
                @include('Admin.Sidebars.StepSuccess')
                {{-- @include('Admin.Sidebars.orders') --}}
                {{-- @include('Admin.Sidebars.payments') --}}
                {{-- @include('Admin.Sidebars.mail_offers') --}}
                @include('Admin.Sidebars.services')
