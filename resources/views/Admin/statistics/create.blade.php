...
@section('content')
<form method="POST" action="{{ route('admin.statistics.store') }}" enctype="multipart/form-data" data-parsley-validate>
    @csrf
    <div class="row">
        ...
        <div class="form-group my-1 col-md-6 col-sm-12">
            ...
            <input required type="text" name="number" value="{{ old('number') }}" placeholder="@lang('trans.number')" class="form-control">
        </div>
