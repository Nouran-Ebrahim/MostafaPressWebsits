...
<div class="row">
    ...
    <div class="my-2 col-6 col-md-3 text-center">
        <a href="{{ route('admin.StepSuccess.create') }}" class="main-btn" disabled>@lang('trans.add_new')</a>
    </div>
    <div class="my-2 col-6 col-md-3 text-center">
        <button type="button" id="DeleteSelected" onclick="DeleteSelected('step_successes')" class="btn btn-dark" disabled>@lang('trans.Delete_Selected')</button>
    </div>
</div>
    ...
    <script type="text/javascript">
        $(function() {
            ...
            var table = $('#DataTable').DataTable({
                ...
                ajax: "{{ route('admin.StepSuccess.index') }}",
                lengthMenu: [
                    [10, 25, 50, -1],
                    [10, 25, 50, "All"]
                ],
